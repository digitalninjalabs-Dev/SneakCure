      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            <SectionHeading
              eyebrow="Trusted by"
              title="Thousands of customers across India"
              titleAccent="Excellence in every restoration"
              gsap
              dense
            />
          </div>
          <div className="lg:col-span-7">
            <p className="text-xl leading-snug text-primary-black/90 text-balance sm:text-2xl md:text-3xl" data-blade>
              Our work is built on trust, craftsmanship, and consistent results. Every pair, bag,
              and leather accessory we restore reflects our commitment to quality, precision, and
              lasting care.
            </p>
          </div>
        </div>
